...
class Pattern(AbstractPatternAnnotator):
    ...
    def __init__(self):
        ...
        self.set_rule_list(rules)
        self.set_included_annots([("", ["Anatomy", "Token"])])
        self.set_pampac_skip("longest")
        self.set_pampac_select("first")
        self.set_pampac_annotator_outset_name("echocardiogram")
        self.annotator()
    ...
    def gen_rule_list():
        ...
        pat1 = Seq(Ann("Token"),
                   AnnAt("Anatomy", name="anat1"), name="longannotname")
        pat2 = Seq(Ann("Token"),
                   AnnAt("Anatomy", name="anat1"),
                   AnnAt("Anatomy", name="anat2"),
                   AnnAt("Token"), name="longannotname")
        action1 = AddAnn(type="PATTERN1",
                         features={"foo0": GetText("longannotname"),
                                   "foo2": GetText("anat1"),
                                   "foo4": GetType("anat1"),
